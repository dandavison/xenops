...
(defun xenops-apply-parse-next-element--do-test (input-text &rest expected-properties)
  (with-temp-buffer
...
(ert-deftest xenops-apply-parse-next-element--block-math ()
  (xenops-apply-parse-next-element--do-test
   "Before.
\\begin{align*}
e^{2i\pi}
\\end{align*}
...
(ert-deftest xenops-apply-parse-next-element--inline-math ()
  (xenops-apply-parse-next-element--do-test
   "Before. $e^{2i\pi}$ After." :type 'inline-math))

(ert-deftest xenops-apply-parse-next-element--inline-math-with-newline ()
  (should-error
   (xenops-apply-parse-next-element--do-test
...
(ert-deftest xenops-apply-parse-next-element--src ()
  (xenops-apply-parse-next-element--do-test
   "Before.
#+begin_src python
def f():
...
(ert-deftest xenops-apply-parse-next-element--minted ()
  (xenops-apply-parse-next-element--do-test
   "Before.
\\begin{minted}{python}
def f():
...
(ert-deftest xenops-apply-parse-next-element--image ()
  (xenops-apply-parse-next-element--do-test
   "Before.
\\includegraphics[width=400pt]{img/zz.png}
After." :type 'image :path (expand-file-name "img/zz.png")))

(ert-deftest xenops-apply-parse-next-element--footnote-1 ()
  (xenops-apply-parse-next-element--do-test
   "Before\\footnote{Simple note contents}. After." :type 'footnote))

(ert-deftest xenops-apply-parse-next-element--footnote-2 ()
  (xenops-apply-parse-next-element--do-test
